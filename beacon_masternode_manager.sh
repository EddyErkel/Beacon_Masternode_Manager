...
# Discord: Eddy#6547                                                                                    #
# Date   : October, 2019                                                                                #
# Github : https://github.com/EddyErkel/Beacon_Masternode_Manager                                       #
#                                                                                                       #
# Disclamer:                                                                                            #
...
COIN_URL="https://github.com/beaconcrypto/beacon/releases/download/v2.0.1.1/beacon-ubuntu16.zip"    # Binaries compressed file. 
COIN_ZIPDIR="/"                                                                                     # Path inside the zipfile that contains the binaries.


# Masternode Bootstrap URL
CHAIN_URL="https://github.com/beaconcrypto/beacon/releases/beacon.zip"                              # Bootstrap compressed file containing chain directory's.
...
NODES_URL="https://github.com/beaconcrypto/beacon/releases/addnodes.txt"                            # Addnodes.txt file.
